...
/**
 * Реферальная программа (2026-09-24).
 *
 * Приглашённый получает бонус сразу при регистрации по ссылке, пригласивший —
 * только после ПЕРВОЙ РЕАЛЬНОЙ ОПЛАТЫ приглашённого. Причина: регистрацию
 * подделать легко (у нас уже есть приветственные гены на каждый новый ящик), а
 * оплату — нет. Награда за регистрацию превратила бы программу в станок по
 * бесплатным генам.
 *
 * Экономика: приглашённый, оплативший пакет 200 ₽, приносит ≈183 ₽ после
 * комиссии и налога при себестоимости генов ≈95 ₽. Награда в 100 генов стоит
 * нам ≈45 ₽ реальных расходов fal — дешевле, чем привлечение из Директа.
 */
export const REFERRAL = {
  /** приглашённому сверх приветственных — сразу при регистрации по ссылке */
  refereeBonus: 25,
  /** пригласившему — один раз, когда приглашённый впервые что-то оплатил */
  referrerReward: 100,
} as const;
