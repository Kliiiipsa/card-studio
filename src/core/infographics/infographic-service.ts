...
ГЛАВНОЕ ПРАВИЛО: цифра сильнее прилагательного. Если в данных есть измеримые факты (объём, вес, размер,
состав в %, срок, количество) — выноси их в блоки ДОСЛОВНО («55 л», «3,1 кг», «хлопок 80%»), а не пересказывай
словами. Прилагательное без конкретики («качественный», «удобный», «стильный») заменяй фактом из данных или выбрасывай.
Но НИКОГДА не придумывай числа, которых нет в данных пользователя.
Заголовок — крупная товарная формула: тип товара + главная выгода, короткими ударными словами.
Не дублируй НИКОГДА: факт, вынесенный в заголовок ИЛИ подзаголовок, в блоках повторно не используй — возьми следующий по силе. Один факт живёт на карточке ровно один раз.`,
        },
        {
          role: "user",
