...
export class MockLLMProvider implements LLMProvider {
  ...
  private compare(ctx: Record<string, unknown>) {
    ...
    return {
      ...
      advantages: [
        "У вас чище и качественнее само фото товара — у конкурента кадр темнее.",
        "У вас нет визуального шума — карточка конкурента перегружена элементами.",
      ],
      weaknesses: [
        "У конкурента заголовок-выгода в верхней трети — на вашей карточке текста нет.",
        "У конкурента три плашки преимуществ — у вас ни одной.",
        "У конкурента бейдж гарантии — на вашей карточке сигналов доверия нет.",
      ],
      adopt: [
