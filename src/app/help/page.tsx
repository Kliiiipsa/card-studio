...
const SCENARIOS: Scenario[] = [
  {
    ...
    lead: "Загружаете фото товара — получаете готовую карточку для Wildberries: крупный заголовок, плашки с преимуществами, товар в сцене. Русский текст рисует сама модель, поэтому он часть картинки, а не наклейка.",
    href: "/infographics",
  ...
  },
  {
    ...
    lead: "Название с главными ключами в начале, продающее описание на 800–1200 знаков и 12–15 реальных поисковых запросов покупателей WB — с кнопками «Копировать».",
    href: "/seo",
