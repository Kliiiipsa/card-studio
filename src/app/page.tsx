 ...
 * Описывает сервис как факты: что это, для кого, диапазон цен. Цены берём из
 * PRICES (1 ген = 1 ₽), чтобы не разъезжались с реальными.
 */
...
const STRUCTURED_DATA: Record<string, unknown>[] = [
  {
    ...
    description:
      "ИИ-сервис для создания карточек товара для маркетплейсов: фото, инфографика с русским текстом, видео, SEO и анализ карточек.",
  },
  {
    "@context": "https://schema.org",
    "@type": "WebSite",
  ...
  },
  {
    ...
    inLanguage: "ru-RU",
    description:
      "Сервис на базе ИИ для селлеров Wildberries и Ozon: за минуты делает фото товара, инфографику с русским текстом и плашками, видео, SEO-тексты и анализ карточек. Загрузите фото — ИИ подберёт стиль и напишет текст, без дизайнера и фотостудии.",
    featureList: [
...
const EXAMPLES: ExampleCard[] = [
  ...
  { src: "/examples/belt.jpg", title: "Кожаный ремень", style: "Премиум кожа" },
  ...
  { src: "/examples/shampoo.jpg", title: "Мужской шампунь", style: "Свежий контраст" },
